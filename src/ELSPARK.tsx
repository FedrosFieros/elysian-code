...
const sections = [
  {
    ...
    content: (
      <>
        ...
        A social digital park
        </p>

        <p className="text cinematic">Built on variety of attractions, it welcomes visitors to connect amongst strangers outside of algorithms.</p>

        <p className="text cinematic">Built on laocracy, with an in-house currency token it is the host of a decentralised society.</p>
    ...
    content: (
      <p className="cinematic">
        ...
        <ul className="bullet-list staged">
          ...
          <li>A social infrastructure for people to come alone and make new friends.</li>
          <li>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <div className="signal-break glitch">
          /// SPACES AVAILABLE ///
        </div>
  
        <ul className="bullet-list staged cinematic ">
          <li>
            <span className="highlight">SOCIAL LABYRINTH</span> —  
            Meet strangers instantly. Speak without identity pressure.
          </li>
  
          <li>
            <span className="highlight">PERSONAL PARK</span> —  
            Track connections. Build your own circle from nothing.
          </li>
  
          <li>
            <span className="highlight">NEWSPAPER</span> —  
            A shared digital chronicle. Everything unfolds in real time.
          </li>
  
          <li>
            <span className="highlight">DIGI-MARKET</span> —  
            Book sessions. Interact with humans or AI entities.
          </li>
        </ul>
  
        <p className="text cinematic">
          Some spaces are built by the system.
        </p>
  
        <p className="text cinematic">
          Others will be built by users.
        </p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text cinematic">elcoins can be purchased and sold based on the <span>euro</span>.</p>
      </>
    ),
  },
    ...
    content: (
      <p className="cinematic">
        <div className="enter-container">
          ...
          <p>This is only the social infrastructure. The 3D world is under construction.</p>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text cinematic">
          It is shaped by its participants.
        </p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text cinematic">
          You do not enter ELSPARK as yourself.
        </p>
