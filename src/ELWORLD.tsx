...
const sections = [
  ...
  },
  {
    ...
    text: [
      "All Arcadians begin inside The Cave. Their birthplace..",
      "However, Ahriman designed these caves to trap people, hypnotising them to then feed them to his wolves.",
      ...
      "However, when they exit, the guard called Con-fo-rma will stop them and ask for a bribe of €20. If the player refuses, Con-fo-rma will fight him to death. She is a good fighter.",
