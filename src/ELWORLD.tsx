...
const sections = [
  {
    ...
    content: (
      <>
        ...
        <p className="text cinematic">A digital planet. Alive through code.</p>

        <p className="text cinematic">Code-L is unfolding.</p>

        <p className="text cinematic">You are not watching it.</p>

        <p className="text cinematic emphasis">You are inside it.</p>
    ...
    content: (
      <p className="cinematic">
        ...
        <ul className="bullet-list staged">
          ...
          <li>
            <span className="highlight">Events unfold in real time.</span>
          </li>
    ...
    content: (
      <>
        ...
        <p className="text cinematic">
          ...
          planet, but ELSPARK exists as an ecosystem outside of his control.
        </p>

        <p className="text cinematic">
          On ELSPARK, no algorithms decide what you see. No ads interrupt your
          experience.
        </p>

        <p className="text cinematic">No subscriptions gate your access.</p>

        <p className="text cinematic emphasis">
          Presence replaces manipulation.
        </p>
        <p className="text cinematic emphasis">
          And soon ELSPARK will help people take back power and claim Arcadia
          back.
        </p>
    ...
    content: (
      <>
        <div className="enter-container">
          <p className="system-msg">ARCADIA IS FINITE</p>

          <p className="text cinematic">Land outside ELSPARK is unclaimed.</p>

          <p className="text cinematic">It is ready to be populated.</p>

          <p className="text cinematic">
            ElCode takes it back from Ahriman and helps individuals build
            exhibitions, launch businesses or form new societies.
          </p>
          ...
          <p className="text cinematic">No purchase required.</p>
        ...
        <div className="signal-break">/// TERRITORY UNLOCKED ///</div>
      </>
    ),
  },
];
