...
"Soon there wont be safe land for none.",
  ...
  },
  {
    ...
    story: [
      ...
      "will you help my sins now to sow.", 
      "from Ahriman's cave I have escaped, now in my own personal hell I will grow.",
      "tab tab tab on my shoulder I feel.",
      "Don",
      "pick it up lick it and i throw it up the wall'",
      "Ellys:",
      "Who said that I am screaming loudly.",
      "Don:","Im Don the scarecrow she said to me. Are you looking for a job by any chance? I see you started planting your own plants. .",
      "Want to make some money for it?.",
      "Ellys:","You want to buy my seeds?.",
     "Don", "No, I will pay you to remove the wheats and make sure they are not taking up soil and water from them.",
      "They exhaust all the resources and seeds have no room to grow..",
      "Ellys","Okay, I can help with that. But what if instead of removing them, we just cut their heads? This would keep some competition for the seeds to grow stronger. ",
"Don",
